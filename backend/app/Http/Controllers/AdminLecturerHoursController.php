...
class AdminLecturerHoursController extends Controller
{
    public function index(Request $request)
    {
        $result = $this->summaryData($request, true);
    ...
    public function show(Request $request, int $lecturer)
    {
        $validated = $this->validateSummaryRequest($request);
        $hoursStageId = $this->resolveHoursStageId();
        $academicYearId = $this->resolveAcademicYearId($validated, null, $lecturer, $hoursStageId);
    ...
    public function exportSummaryExcel(Request $request)
    {
        ...
        return app('excel')->download(new AdminLecturerHoursSummaryExport($exportRows, [
    ...
    private function summaryData(Request $request, bool $paginate): array
    {
        ...
        $hoursStageId = $this->resolveHoursStageId();
        $academicYearId = $this->resolveAcademicYearId($validated, null, null, $hoursStageId);
        $academicYearCode = $this->resolveAcademicYearCode($academicYearId);
        $requiredHours = $this->resolveRequiredHours($academicYearId);
    ...
    private function validateSummaryRequest(Request $request): array
    {
    ...
    private function resolveExportScopeLabel(int $facultyId): string
    {
        ...
        return (string) (DB::table('faculties')->where('id', $facultyId)->value('name') ?? 'Toàn trường');
    }
}

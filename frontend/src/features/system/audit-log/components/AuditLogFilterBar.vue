<template>
  ...
  >
    <div class="flex items-start justify-between gap-3">
      ...
      <button
        type="button"
        class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 disabled:opacity-50"
        :disabled="isLoading"
        @click="emit('reset')"
      >
    ...
    <div class="mt-4 grid gap-3 md:grid-cols-12 md:items-end">
      ...
      <!-- Faculty (controlled by parent via prop) -->
      ...
      <div class="md:col-span-2">
        <button
          type="button"
          class="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-slate-900 px-3 py-2 text-sm font-semibold text-white hover:bg-slate-800 disabled:opacity-50"
          :disabled="isLoading"
          @click="emit('apply')"
        >

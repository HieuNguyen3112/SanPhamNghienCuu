    ...
    >
      ...
      <div class="flex flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <select
          ...
          class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm focus:border-slate-300 focus:outline-none sm:w-[240px] disabled:bg-slate-50"
        >
          <option v-if="showAllFacultyOption" value="ALL">Tất cả khoa</option>
...
withDefaults(
  defineProps<{
    ...
    showAllFacultyOption?: boolean;
  }>(),
  {
    allowCreate: true,
    allowEdit: true,
    facultySelectDisabled: false,
    showAllFacultyOption: true,
  }
);

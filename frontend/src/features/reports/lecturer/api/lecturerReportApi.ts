...
export async function fetchLecturerReportFilters(): Promise<LecturerReportFiltersResponse> {
  const { data } = await http.get<ApiResponse<LecturerReportFiltersResponseDTO>>(
    "/api/admin/reports/lecturers/filters"
  );
  return {
...
export async function fetchLecturerReport(params: {
  faculty_id?: number;
  degree_id?: number;
...
export async function exportLecturerReportExcel(params: {
  faculty_id?: number;
  degree_id?: number;
  academic_rank_id?: number;
  gender?: string;
  ...
  return exportReport(
    "/api/admin/reports/lecturers/export/excel",
    params,
    "lecturer_report.xlsx"
  );
}

export async function exportLecturerReportPdf(params: {
  faculty_id?: number;
  degree_id?: number;
  academic_rank_id?: number;
  gender?: string;
  ...
  return exportReport(
    "/api/admin/reports/lecturers/export/pdf",
    params,
    "lecturer_report.pdf"
  );
}

...
import HoursProgressBar from "@/features/scientific/hours/components/HoursProgressBar.vue";
import type { FacultyHoursItem } from "@/features/scientific/hours/types";

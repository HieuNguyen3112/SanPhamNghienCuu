...
import { createLecturerResearchWorkClient } from "@/features/scientific/research-work-management/api/lecturerResearchWork.client";
import type { FilterState } from "@/features/scientific/research-work-management/lecturerResearchWork.contracts";
import { useLecturerResearchWorkManagement } from "@/features/scientific/research-work-management/composables/useLecturerResearchWork";
import PageHeader from "@/shared/components/layout/PageHeader.vue";
const client = createLecturerResearchWorkClient({ scope: "faculty" });

...
export async function exportFacultyHoursExcel(
  params: ExportHoursParams
): Promise<ExportResult> {
  return exportSummary(
    "/api/faculty/hours/lecturers/summary/export/excel",
    params,
    "hours_summary_lecturers.xlsx"
  );
}

export async function exportFacultyHoursPdf(
  params: ExportHoursParams
): Promise<ExportResult> {
  return exportSummary(
    "/api/faculty/hours/lecturers/summary/export/pdf",
    params,

  ...
  <div class="space-y-3">
    ...
    >
      <div class="text-sm text-slate-600">
        Đang hiển thị
        <span class="font-semibold text-slate-900">Loại công trình</span>
      </div>
      ...
      <table class="w-full text-left text-sm">
        <thead class="sticky top-0 z-10 bg-slate-50 text-xs text-slate-600">
          <tr>
            ...
            <th class="px-4 py-3">Tên loại công trình</th>
            <th class="px-4 py-3">Mô tả</th>
            <th class="w-32 px-4 py-3">Trạng thái</th>
            <th class="w-44 px-4 py-3">Cập nhật</th>
...
defineProps<{
  ...
  modalTitle: string;
  submitting: boolean;
  form: { id: number; name: string; description: string; isActive: boolean };

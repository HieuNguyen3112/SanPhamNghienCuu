...
import type {
  ...
  ResearchReportTable,
} from "@/features/reports/research/researchReportTypes";
...
export async function fetchFacultyResearchReportFilters(): Promise<ResearchReportFiltersResponse> {
  const { data } = await http.get<ApiResponse<FiltersResponseDTO>>(
    "/api/faculty/reports/research/filters"
  );
...
export async function fetchFacultyResearchReport(params: {
  year?: number;
...
export async function exportFacultyResearchReportExcel(params: {
  year?: number;
  department_id?: number;
  research_type?: ResearchReportFilters["researchType"];
  lecturer_id?: number;
  ...
  return exportReport(
    "/api/faculty/reports/research/export/excel",
    params,
    "faculty_research_report.xlsx"
  );
}

export async function exportFacultyResearchReportPdf(params: {
  year?: number;
  department_id?: number;
  research_type?: ResearchReportFilters["researchType"];
  lecturer_id?: number;
  ...
  return exportReport(
    "/api/faculty/reports/research/export/pdf",
    params,
    "faculty_research_report.pdf"
  );
}
